  ...
  METHOD http_get.
    ...
    IF lt_config IS INITIAL.
      lt_config = VALUE #(
          ...
          (  n = `src`                       v = `https://ui5.sap.com/1.119.2/resources/sap-ui-core.js` )
*          (  n = `src`                       v = `https://sdk.openui5.org/resources/sap-ui-cachebuster/sap-ui-core.js` )
    ...
    r_result = `<html>` && |\n| &&
               ...
               `        }` && |\n| &&
               `    </style> ` &&
               `    <link rel="stylesheet" type="text/css" href="https://hhpy410.github.io/ATU/atu_style.css">` && |\n| &&
...
*                           |\n| &&
                           ...
                           `   if ( sap.z2ui5.isBusy && sap.z2ui5.isBusy == true ){  sap.z2ui5.b = new sap.m.BusyDialog();    sap.z2ui5.b.open(); return; } ` && "hhpy
                           `                sap.z2ui5.isBusy = true; ` && "hhpy
